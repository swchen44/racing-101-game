...
const STRINGS = {
  zh: {
    ...
    secRole: '扮演角色 ROLE',
    secGhost: '幽靈車對戰 GHOST', ghostOff: '關閉', ghostOffDesc: '單純刷新自己的最速紀錄',
    ghostOn: '對戰幽靈', ghostVsBest: '與自己最佳單圈的幽靈同場競速', ghostNoRecord: '先在此賽道跑一趟建立紀錄',
    roleCop: '警察', roleCopEn: 'COP', roleCopDesc: '追撞小偷,撞翻 3 次制伏',
    roleThief: '小偷', roleThiefEn: 'THIEF', roleThiefDesc: '開贓車逃,撐過倒數就脫身',
    chaseCopLabel: '制伏小偷', chaseThiefLabel: '甩開警察', chaseShaken: '已甩開 ✓', chaseShakenMsg: '甩 開 警 察 了!',
    goSubChaseCop: '追 上 小 偷', goSubChaseThief: '別 被 攔 下',
    chaseWin: '制 伏 歸 案', chaseWinEn: 'SUSPECT DOWN', chaseEscape: '成 功 脫 身', chaseEscapeEn: 'GOT AWAY',
    chaseCaught: '你 被 逮 了', chaseCaughtEn: 'BUSTED', chaseTimeUp: '時 間 到',
    resTime: '耗時', resSurvive: '存活時間', resHealth: '剩餘血量',
    ...
    boardHead: ['#', '車手', 'IP', '時間', '日期'], boardEmpty: '🏁 這個分組還沒有紀錄 — 成為第一個上榜的車手!',
    labMode: '模式', labTrack: '賽道', labDiff: '對手強度',
    transAutoSub: 'AUTOMATIC', transManualSub: 'MANUAL',
    carClass: (c) => c,
  ...
  en: {
    ...
    secRole: 'ROLE',
    secGhost: 'GHOST RACE', ghostOff: 'OFF', ghostOffDesc: 'Just chase your own best time',
    ghostOn: 'RACE GHOST', ghostVsBest: 'Race the ghost of your best lap', ghostNoRecord: 'Set a lap here first to unlock',
    roleCop: 'Cop', roleCopEn: 'POLICE', roleCopDesc: 'Ram the thief — 3 hits to take down',
    roleThief: 'Thief', roleThiefEn: 'ROBBER', roleThiefDesc: 'Flee in a stolen car, outlast the timer',
    chaseCopLabel: 'TAKE DOWN', chaseThiefLabel: 'ESCAPE', chaseShaken: 'SHAKEN ✓', chaseShakenMsg: 'YOU SHOOK THEM OFF!',
    goSubChaseCop: 'CATCH THE THIEF', goSubChaseThief: "DON'T GET CAUGHT",
    chaseWin: 'SUSPECT DOWN', chaseWinEn: 'SUSPECT DOWN', chaseEscape: 'GOT AWAY', chaseEscapeEn: 'GOT AWAY',
    chaseCaught: 'BUSTED', chaseCaughtEn: 'BUSTED', chaseTimeUp: "TIME'S UP",
    resTime: 'Time', resSurvive: 'Survived', resHealth: 'Health left',
    ...
    boardHead: ['#', 'DRIVER', 'IP', 'TIME', 'DATE'], boardEmpty: '🏁 No records in this bracket — be the first on the board!',
    labMode: 'MODE', labTrack: 'TRACK', labDiff: 'AI LEVEL',
    transAutoSub: '自排', transManualSub: '手排',
    carClass: (c) => ({ '賽車': 'RACE', '電動車': 'EV', '越野車': 'OFF-ROAD', '轎車': 'SEDAN', '休旅車': 'SUV' }[c] || c),
